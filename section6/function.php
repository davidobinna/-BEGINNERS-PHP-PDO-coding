...
function insert_author(\PDO $pdo, string $first_name, string $last_name):int
{
    ...
    $statement->bindParam(':first_name',$first_name, PDO::PARAM_STR);
    $statement->bindParam(':last_name',$first_name, PDO::PARAM_STR);
 ...
 <?php
  ...
  function insert_book(\PDO $pdo, string $title, string $isbn, string $published_date, int $publisher_id)
   {
      ...
      $statement->bindParam(':publisher_id', $publisher_id, PDO::PARAM_STR);
...
function insert_book_author(\PDO $pdo, int $book_id, int $author_id)
{
    ...
    $statement->bindParam(':author_id', $book_id, PDO::PARAM_STR);
